...
void AddPerson(Person *pers, int &size)
{
	...
	pers = (Person*)realloc(pers, (++size) * sizeof(pers));
	...
	cin.getline(str, 50);
	strcpy(temp[size].name, str);
	row += 2;

	//SetConsoleCursorPosition(h, { col, row });
	//cin.getline(str, 50);
	//strcpy(person[size].surname, str);
	//row += 2;

	//SetConsoleCursorPosition(h, { col, row });
	//cin >> myage;
	//person[size].age = myage;
	////cin.getline(str, 50);
	...
	//SetConsoleCursorPosition(h, { col, row });
	//cin.getline(str, 50);
	//strcpy(person[size].number, str);
	//row += 2;

	//SetConsoleCursorPosition(h, { col, row });
	//cin.getline(str, 50);
	//strcpy(person[size].email, str);
